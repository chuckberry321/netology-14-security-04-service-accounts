...
```
vagrant@vagrant:~/netology-14-security-04-service-accounts$ kubectl run -i --tty fedora --image=fedora --restart=Never -- sh
...
E0204 21:20:13.563613   22503 v2.go:105] EOF
vagrant@vagrant:~/netology-14-security-04-service-accounts$
